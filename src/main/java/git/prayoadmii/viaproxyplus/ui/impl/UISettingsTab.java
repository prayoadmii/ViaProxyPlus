...
public class UISettingsTab extends UITab {
    ...
    protected void init(JPanel contentPane) {
        ...
        int gridy = 0;
        {
            ...
            language.addActionListener(event -> {
                ...
                try {
                    ...
                    Logger.LOGGER.error("Could not start the ViaProxyPlus jar", e);
        ...
        GBC.create(body).grid(0, gridy++).weightx(1).insets(0, BORDER_PADDING, 0, BORDER_PADDING).fill(GBC.HORIZONTAL).add(new LinkLabel(I18n.get("tab.ui_settings.translate.link"), "https://github.com/prayoadmii/ViaProxyPlus"));
